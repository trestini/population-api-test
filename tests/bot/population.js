...
/**
 * Test for /bot/population
 */
Test('/bot/population', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getPopulation get operation', function (t) {
            Mockgen().requests({
                path: '/bot/population',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/bot/population']['get']['responses']['200']['schema']);
